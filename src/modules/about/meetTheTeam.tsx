            ...
            <div className="max-w-[1200px] m-auto">
                <div>
                    <header className="text-center">
                        <h1 className="text-[#08569C] text-[50px] font-[800]">
                            Meet the Team
                        </h1>
                        <p className="text-[#525252] text-[28.65px] font-[400] max-w-[943px] m-auto">
                    ...
                    <div className="m-auto mt-[3rem]">
                        <div className="m-auto max-w-[368.9792175292969px]">
                        ...
                        <p className="text-[28.65px] text-center font-[600] text-[#525252] max-w-[943px] m-auto mt-4">
                ...
                <section className="flex items-center gap-[2rem] my-[6rem]">
                    {data.map((list) =>
                        <div
                            key={list.name}
