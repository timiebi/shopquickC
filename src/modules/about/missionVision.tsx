                ...
                <div className="max-w-[1200px] m-auto">
                    <div className="mb-7">
                        ...
                        <p className="text-[28.65px] font-[400] text-[#525252] text-center">
                            ...
                            food
                            waste, all while making shopping more intelligent, sustainable, and enjoyable. At ShopQuick,
                            we’re
                    ...
                    <div>
                        ...
                        <p className="text-[28.65px] font-[400] text-[#525252] text-center">
                            ...
                            innovative technology and data insights, we are committed to transforming the shopping
                            experience—helping consumers save money, reduce waste, and shop smarter for a better tomorrow.
                        </p>
                    </div>
                </div>
            </div>
            <div className="max-w-[622px] m-auto">
