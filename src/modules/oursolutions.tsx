        ...
        <main style={{fontFamily: "Montserrat, sans-serif"}}>
            <div className="max-w-[1200px] m-auto mt-[6rem]">
                <div className="max-w-[943px] m-auto">
                    <h2 className="text-[25px] md:text-[28.65px] text-[#525252] text-center font-[700]">OUR SOLUTION</h2>
            ...
            <div className="bg-[#C7E6FF] py-[60px] md:px-[188px] px-[25px] mt-[4rem]">
                <div className="md:max-w-[1060px] m-auto grid grid-cols-1 md:grid-cols-2 gap-[2.5rem]">
                    {data.map((list, index) =>
                        ...
                        <h3 className="text-[#08569C] text-[26.76px] font-[700] text-center md:max-w-[280px] m-auto mb-4">
                            {list.header}
                        </h3>
                        <p className="md:max-w-[388.2887878417969px] text-[19.09px] text-[#3B3B3B] font-[500] text-center m-auto">
                            {list.description}
                        </p>
                    </div>)}
                </div>
