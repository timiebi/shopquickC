      ...
      <div className="mt-[6rem]">
         <div className="max-w-[1200px] m-auto" style={{ fontFamily: "Montserrat, sans-serif" }}>
            <div className="mb-[3rem]">
               <h2 className="text-[25px] md:text-[1.5rem] font-[700] text-[#525252] text-center">
                  THE PROBLEM
               </h2>
               <h1 className="text-[30px] md:text-[3rem] font-[800] text-[#08569C] text-center max-w-[348px] md:max-w-full m-auto">
                  Your Grocery Shopping is Broken.
               </h1>
               <p className="text-[#525252] text-[18px] md:text-[1.4rem] font-[400] max-w-[348px] md:max-w-[662px] text-center m-auto">
                  Grocery shopping is outdated and frustrating. But it doesn’t have to be.
               </p>
            </div>
            <div className="flex md:flex-row flex-col max-w-[348px] md:max-w-full justify-between gap-[3rem] m-auto">
               <div className="flex flex-col gap-[1rem] justify-between">
                  ...
                  {problemList.map((item) => (
                     ...
                     >
                        <div className="">
                           {/* {item.icon && item.icon} */}
                           <p className="text-[13.71px] md:text-[1.2rem] text-[#525252] font-[600] max-w-[522px]">
                              {item.text}
                           </p>
                        </div>
                     </div>
               ...
               <div className="md:max-w-[627.6878051757812px] max-w-[334px] m-auto">
                  <img
                     src="/assets/shopQuickProblem.png"
                     alt=""
                     className="rounded-[21.9px] w-full cover max-w-[627.6878051757812px]"
                  />
               </div>
            </div>
         </div>
