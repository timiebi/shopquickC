                ...
                <div
                    ...
                    <div className="max-w-[1200px] m-auto pt-[4rem]">
                        <div className="flex items-center justify-center gap-[2rem]">
                            <div>
                                <h1 className="text-[73.47px] text-[#08569C] font-[700] leading-[50px] mb-[2rem] text-center">
                                    Bringing Joy to Every Cart
                                </h1>
                                <p className="text-[25px] font-[400] text-[#1C1C1C] max-w-[1000px] mb-[2rem] text-center m-auto">
